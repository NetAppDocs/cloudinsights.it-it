...
La sicurezza del carico di lavoro viene misurata a seconda che i nodi utilizzati siano di fascia alta, di fascia media o di livello base, ai seguenti conteggi delle unità gestite (MU):

|===


| Tipo di nodo: | Modelli di esempio: | Misurato a: 


| 1 nodo high-end | 700, 800, 900, 9xxx | 80 unità gestite 


| 1 nodo intermedio | 300, 400, 500, 8x00 | 40 unità gestite 


| 1 nodo entry-level | 1xx, 2xx, 2xxx | 20 unità gestite 


| 1 Software ONTAP | CVO, FSX | 10 unità gestite 


| 1 nodo sconosciuto |  | 80 unità gestite 
|===

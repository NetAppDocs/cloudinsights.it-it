...
summary: 'Audit fornisce una vista delle attività del sistema e dell"utente nel sistema Cloud Insights.' 
---
= Controllo
:toc: macro
:hardbreaks:
...
+
Esempio: _Utente *Tony Lavoie* connesso da *10.1.120.15*, agente utente *Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/85.0.4183.121 Safari/537.36*, metodi di login *Cloud Central Portal Login_*

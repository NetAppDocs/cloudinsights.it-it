...
....
Assicurarsi di esaminare la sezione autorizzazioni di link:/cloudinsights/task_add_collector_svm.html["Configurazione del Data Collector SVM di ONTAP"] pagina pure.

...
NOTE: Questo data collector non è più disponibile per l'installazione in Cloud Insights a partire dal 4 aprile 2023 e verrà rimosso da tutte le installazioni di Cloud Insights a luglio 2023. Per informazioni sulla transizione alla raccolta di dati basata su AU, vedere link:https://kb.netapp.com/Advice_and_Troubleshooting/Cloud_Services/Cloud_Insights/How_to_transition_from_NetApp_Cloud_Connection_to_AU_based_data_collector["Knowledge base"^].

...
.Fasi
. Nel menu Cloud Insights, fare clic su *osservabilità > Collector*
+
...
. Nel menu Cloud Insights, fare clic su *osservabilità > Collector* per aprire l'elenco dei Data Collector installati.

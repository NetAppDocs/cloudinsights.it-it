...
* *Chat* - sarai in contatto con il personale di supporto NetApp per ricevere assistenza (solo nei giorni feriali). La chat è disponibile nell'opzione di menu *Guida > Chat live* in alto a destra di qualsiasi schermata di Cloud Insights.

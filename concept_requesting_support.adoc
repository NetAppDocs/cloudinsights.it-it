...
NetApp offre supporto per le informazioni sull'infrastruttura dati in vari modi. Sono disponibili opzioni complete di supporto autonomo gratuito 24 ore su 24, 7 giorni su 7, come articoli della knowledge base (KB) o la community NetApp. Per gli utenti abbonati a una delle edizioni Data Infrastructure Insights (Basic*, Standard, Premium), il supporto tecnico è disponibile tramite telefono o ticket Web. Per il ticket Web e la gestione del caso è necessario un account SSO NetApp Support Site (NSS).

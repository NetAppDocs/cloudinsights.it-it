...
* È necessario avere accesso a un account utente con il livello di accesso richiesto
* I dettagli dell'account includono nome utente e password.
* Requisiti di porta: 443
* Permessi dell'account:
+
** Dal punto di vista funzionale, Cloud Insights sta effettuando richieste di lettura, ma sono necessarie alcune autorizzazioni di scrittura affinché ci si registri con l'array ONTAP. Vedere la nota sulle autorizzazioni riportata di seguito.

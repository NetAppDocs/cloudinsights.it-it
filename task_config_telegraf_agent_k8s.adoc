...
summary: 'L"operatore di monitoring NetApp Kubernetes raccoglie i dati Kubernetes per l"utilizzo in Cloud Insights.' 
---
...
IMPORTANT: Leggere il link:pre-requisites_for_k8s_operator.html["*Prima dell'installazione o dell'aggiornamento*"] Documentazione pre-requisiti prima di installare o aggiornare l'operatore di monitoraggio Kubernetes NetApp.

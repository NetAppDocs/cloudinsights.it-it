...
Modificare l'implementazione dell'operatore di monitoraggio in operator-config.yaml e modificare tutti i riferimenti alle immagini per utilizzare il repository Docker privato.

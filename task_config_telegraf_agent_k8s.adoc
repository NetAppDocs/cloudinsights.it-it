...
| I miei eventi kuowski hanno inaspettatamente smesso di segnalare a Cloud Insights. | Recuperare il nome dell'evento-esportatore pod `kubectl -n netapp-monitoring get pods 


| grep event-exportant | awk '{print $1}' 
|===

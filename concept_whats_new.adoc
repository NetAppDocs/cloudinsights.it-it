...
Il componente di reporting di Cloud Insights è stato chiamato nuovamente "Cloud Insights Analytics". Tuttavia, non preoccuparti, le funzionalità rimangono le stesse.

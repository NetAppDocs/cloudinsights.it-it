...
=== Report dei dati PV di Kubernetes

Le informazioni sui volumi persistenti (PV) di Kubernetes raccolte da Cloud Insights sono ora disponibili per l'utilizzo nei report, consentendo chargeback, trend, previsioni, calcoli TTF, E altri report aziendali sulle metriche per cluster Kubernetes, namespace, carichi di lavoro e altro ancora.

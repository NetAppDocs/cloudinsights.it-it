...
=== Latenza del volume iSCSI

Le metriche per la latenza del volume iSCSI sono disponibili per l'utilizzo in dashboard, avvisi e altro ancora. Per raccogliere le metriche di latenza iSCSI, attivare _Network Performance and Map_ dalla voce di menu "Modifica distribuzione" di Kubernetes Collector.

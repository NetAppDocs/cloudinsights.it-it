...
Per csuser con credenziali _cluster_, eseguire i seguenti comandi dalla riga di comando di ONTAP. Si noti che _csrole_ è un ruolo personalizzato e _csuser_ è un utente personalizzato di ONTAP.

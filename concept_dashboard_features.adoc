...
NOTE: Poiché NetApp Cloud Central ha un timeout di accesso utente di 7 giorni, Cloud Insights deve disconnettersi anche con quell'evento. Puoi semplicemente effettuare nuovamente l'accesso e la dashboard continuerà a essere visualizzata.

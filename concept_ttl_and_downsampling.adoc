...
summary: 'Time-to-Live (TTL): Vengono spiegate la conservazione dei dati e il downsampling' 
...
== Data retention (nota anche come time-to-live)
...
| Premium | 90 giorni 
|===
Gli abbonamenti Premium Edition con almeno 500 unità gestite (MU) conservano i dati di Business Intelligence e Reporting per 13 mesi.

...
Cloud Insights conserva i dati per un periodo di tempo determinato dall'edizione sottoscritta attiva.
...
| Premium | 13 mesi 
|===
Un elenco completo delle funzioni disponibili in ciascuna edizione è disponibile sul Cloud Insights link:https://bluexp.netapp.com/cloud-insights-pricing["Edizioni e Prezzi"] pagina.

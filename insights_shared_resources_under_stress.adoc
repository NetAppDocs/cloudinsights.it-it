...
Cloud Insights visualizza un elenco dei carichi di lavoro in cui è stata rilevata una saturazione. Si noti che Cloud Insights mostrerà i carichi di lavoro in cui è stata rilevata almeno una _risorsa impegnativa_ *o* _risorsa interessata_.
...
image:ResourceInsightDemanding.png["Grafico dei carichi di lavoro esigenti"]
image:ResourceInsightImpacted-a.png["Grafico dei carichi di lavoro interessati"]
